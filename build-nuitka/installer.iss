; Inno Setup script for Viable
; Compile with Inno Setup 6.x: https://jrsoftware.org/isinfo.php

#define MyAppName "Viable"
#define MyAppVersion "0.7.5"
#define MyAppPublisher "Viable"
#define MyAppURL "https://github.com/viable-kb/gui"
#define MyAppExeName "Viable.exe"
...
; Output settings
OutputDir=output
OutputBaseFilename=Viable-{#MyAppVersion}-Setup
